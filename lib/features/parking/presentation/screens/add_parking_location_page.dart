...
class _AddParkingLocationPageState
  ...
  Future<void> _getCurrentLocation() async {
    try {
      ...
      if (result.isSuccess && result.position != null) {
        ...
        AppLogger.debug('📍 Current location: ${result.position!.latitude}, ${result.position!.longitude}',);
      } else {
        AppLogger.debug('❌ Error getting location: ${result.errorMessage}');
        _handleLocationError(result);
      }
    } catch (e) {
      AppLogger.debug('❌ Exception getting location: $e');
  ...
  Future<void> _pickImage(ImageSource source) async {
    try {
      ...
      if (pickedFile != null) {
        ...
        AppLogger.debug('📸 Image selected: ${pickedFile.path}');
      }
    } catch (e) {
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      AppLogger.debug('❌ Error submitting form: $e');
