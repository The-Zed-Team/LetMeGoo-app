...
import 'package:letmegoo/features/vehicle/presentation/widgets/vechile_already_register_dialog.dart';
...
class _AddvehicledialogState extends ConsumerState<Addvehicledialog> {
  ...
  VehicleTypeInfo? selectedVehicleType;
  ...
  void initState() {
    super.initState();
    // Vehicle types are now loaded via vehicleTypesProvider
  }
  ...
  Future<void> _addVehicle() async {
    ...
    try {
      ...
      final newVehicle = await createVehicleUseCase(
        CreateVehicleParams(
                ...
                error:
                    (error, _) => Padding(
                      ...
                      child: Text(
                        ...
                        style: AppFonts.regular14(color: AppColors.darkRed),
                      ),
                    ),
                data:
                    (vehicleTypes) => SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          DropdownButtonFormField<VehicleTypeInfo>(
                            ...
                            items:
                                vehicleTypes.map((VehicleTypeInfo type) {
                                  return DropdownMenuItem<VehicleTypeInfo>(
                                    value: type,
                                    child: Text(type.key),
                                  );
                                }).toList(),
