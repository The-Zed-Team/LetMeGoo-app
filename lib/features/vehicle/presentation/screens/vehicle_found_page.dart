...
class _VehicleFoundPageState extends State<VehicleFoundPage> {
  ...
  void _makePhoneCall(String phoneNumber) async {
    ...
    AppLogger.debug('Attempting to call: $cleanNumber'); // Debug log
    AppLogger.debug('Launch URI: $launchUri'); // Debug log
    ...
    try {
      if (await canLaunchUrl(launchUri)) {
        ...
        AppLogger.debug('Cannot launch URL: $launchUri'); // Debug log
        _showErrorSnackBar(
          'Could not launch phone dialer. Phone app may not be available.',
        );
      }
    } catch (e) {
      AppLogger.debug('Error launching phone dialer: $e'); // Debug log
