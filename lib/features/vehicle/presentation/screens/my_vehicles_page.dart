...
import 'package:letmegoo/features/vehicle/presentation/providers/user_vehicles_notifier.dart';
...
class _MyVehiclesPageState extends ConsumerState<MyVehiclesPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(userVehiclesNotifierProvider.notifier).loadVehicles();
    });
  }
  ...
  Future<void> _deleteVehicle(String vehicleId) async {
    try {
      final bool success = await ref
          .read(userVehiclesNotifierProvider.notifier)
  ...
  Widget build(BuildContext context) {
    ...
    // Watch vehicle state
    final vehicleState = ref.watch(userVehiclesNotifierProvider);
    ...
    return Column(
      ...
      children: [
        ...
        ...vehicles.map((vehicle) {
          final String vehicleTypeDisplay = ref
              .read(userVehiclesNotifierProvider.notifier)
              .getVehicleTypeDisplay(vehicle.vehicleType);

          // Display value is already formatted by the notifier
      ...
      builder:
          (_) => Addvehicledialog(
            onAdd: (newVehicle) {
              ...
              ref.read(userVehiclesNotifierProvider.notifier).refreshVehicles();
            },
            onCancel: () {
              Navigator.pop(context);
            },
