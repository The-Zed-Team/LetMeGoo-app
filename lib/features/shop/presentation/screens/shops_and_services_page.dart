...
import 'package:letmegoo/features/shop/presentation/widgets/shop_card.dart';
import 'package:letmegoo/features/shop/presentation/providers/shop_provider.dart';
import 'package:geolocator/geolocator.dart';
import 'package:letmegoo/core/utils/logger.dart';

class ShopsAndServicesPage extends ConsumerStatefulWidget {
  final Function(int)? onNavigate;
  final VoidCallback? onAddPressed;
  const ShopsAndServicesPage({super.key, this.onNavigate, this.onAddPressed});

  @override
  ConsumerState<ShopsAndServicesPage> createState() =>
      _ShopsAndServicesPageState();
}

class _ShopsAndServicesPageState extends ConsumerState<ShopsAndServicesPage> {
  ...
  Future<void> _loadShops({bool loadMore = false}) async {
    try {
      ...
      final getShopsWithDistance = ref.read(
        getShopsWithDistanceUseCaseProvider,
      );
      final shops = await getShopsWithDistance(
  ...
  Future<void> _getCurrentLocation() async {
    ...
    try {
      ...
      AppLogger.debug('Location error: $e');
    }
  }
