...
import 'package:letmegoo/features/vehicle/presentation/screens/add_vehicle_page.dart';
  ...
  Future<void> _updateUserProfile() async {
    ...
    try {
      ...
      try {
        ...
        AppLogger.debug('User exists in backend, updating profile...');
      } catch (e) {
        AppLogger.debug('User may not exist in backend yet: $e');
        result = null;
      }
      ...
      if (result != null) {
        ...
        AppLogger.debug('New user detected, creating backend user...');
      ...
      AppLogger.debug('Auth error: ${e.toString()}');
      ...
      AppLogger.debug('Profile creation error: ${e.toString()}');
