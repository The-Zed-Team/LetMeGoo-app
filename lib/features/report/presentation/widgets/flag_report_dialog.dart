...
class FlagReportDialog extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<FlagReportDialog> createState() => _FlagReportDialogState();
}

class _FlagReportDialogState extends ConsumerState<FlagReportDialog> {
  ...
  Future<void> _submitFlag() async {
    ...
    try {
      // Use the provider to flag the report
      await ref.read(reportsProvider.notifier).flagReport(widget.reportId);
