...
class SeenByOwnerPage extends StatelessWidget {
  const SeenByOwnerPage({super.key});
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Text("Seen By Owner", style: AppFonts.semiBold24()),
            const SizedBox(height: 10),
            Text(
              "The vehicle owner has viewed your report\nand has been made aware of the issue.\nWe'll let you know once they take action or\nmark it as resolved.",
